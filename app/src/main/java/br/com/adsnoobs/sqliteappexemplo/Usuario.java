...
public class Usuario {
    ...
    public boolean salvar(){
        ...
        try{
            ...
            String sql = "";
            if (codigo == -1){
                sql = "INSERT INTO usuario (nome,email,senha,func,imagem) VALUES (?,?,?,?)";
            }else{
                sql = "UPDATE usuario SET nome = ?, email = ?, senha = ?,func = ?, imagem = ? WHERE codigo = ?";
            }
            sqLiteDatabase.beginTransaction();
            ...
            sqLiteStatement.bindString(3,func);
            if (imagem != null)
    ...
    public ArrayList<Usuario> getUsuarios(){
        ...
        try{
            ...
            while (cursor.moveToNext()){
                ...
                usuario.func= cursor.getString(cursor.getColumnIndex("func"));
    ...
    public void carregaUsuarioPeloCodigo(int codigo){
        ...
        try{
            ...
            while (cursor.moveToNext()){
                ...
                func= cursor.getString(cursor.getColumnIndex("func"));
