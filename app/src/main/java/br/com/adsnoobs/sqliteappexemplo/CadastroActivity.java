...
public class CadastroActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selecione = (Spinner) findViewById(R.id.spinnerFunc);
        ArrayAdapter adapter = ArrayAdapter.createFromResource(this,R.array.selecione_func,android.R.layout.simple_spinner_item);
        selecione.setAdapter(adapter);
        ...
        if (getIntent().getExtras() != null){
            ...
            selecione.setSelected(Boolean.parseBoolean(usuario.getfunc().toString()));
        }else{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.buttonSalvar :{
                ...
                usuario.setFunc(selecione.getSelectedItem().toString().trim());
                carregaImagem();
